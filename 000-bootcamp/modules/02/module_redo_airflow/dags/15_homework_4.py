# 4. How many rows are there for
# the `Green` Taxi data for all CSV files in the year 2020?
...
def homework_4():
  ...
  def count_rows(config: dict) -> int:
    ...
    print(f"There are {count} rows the `Green` Taxi data for all CSV files in the year 2020.")
